...
import styles from "./popularFlight.module.scss";
      ...
      <div className={styles.secContainer}>
        <div className={styles.secHeader}>
          <div className={styles.textDiv}>
            ...
            <p>
              Từ những thành phố đậm đà bản sắc văn hóa đến những kỳ quan thiên nhiên, khám phá vẻ đẹp của Việt Nam và Thế Giới!
            </p>
